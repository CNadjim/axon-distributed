...
/**
 * Spring Message representing a reply to a dispatched command.
 *
 * @author Steven van Beelen
 * @since 3.0
 */
public class SpringReplyCommandMessage<R> extends ReplyMessage implements Serializable {
     ...
     */
    public SpringReplyCommandMessage(String commandIdentifier,
    ...
    private SpringReplyCommandMessage() {
